...
```bash
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc <command>
```
...
if ! command -v git-annex >/dev/null; then
  LC_ANNEX="uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 git-annex"
...
`uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 git-annex <cmd>`.
...
```bash
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc init [DIR] [--check] [--json]   # Converge DIR into a standard project (idempotent)
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc status [--json]                 # Report each output's state; always exits 0
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc materialize [TARGETS...] [--check] [--refresh] [--json]  # Make outputs, committing each
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc run COMMAND...                  # Probe: run one command in the project env, sandboxed
uvx --from git+https://github.com/LightconeResearch/lightcone-cli@4fa2d1b4e5afaee81dfbfab1a64149d2792f85b3 lc build [--json]                  # Build & commit the system-layer image (containerized)
```
